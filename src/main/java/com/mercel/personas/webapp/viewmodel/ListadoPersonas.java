...
public class ListadoPersonas extends SelectorComposer<Component> {
	...
	public void search(){
		setPersonaList(null);
		setPersonaList(personaServiceImpl.findPersonas(new PagingLoadConfig(limit,activePage), "id", sortOrder,getKeyword(),itemCombo));
		actualizarCantidad();
	}
	...
	public void actualizarCantidad() {
		...
		setCant(personaServiceImpl.getPersonasCantidad(getKeyword(),itemCombo));
	}
